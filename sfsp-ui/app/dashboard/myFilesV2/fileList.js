...
export function FileList({
  ...
  const iconMap = {
    ...
    png: <Image className="h-5 w-5 text-green-500" alt=""/>,
    jpg: <Image className="h-5 w-5 text-green-500" alt=""/>,
    jpeg: <Image className="h-5 w-5 text-green-500" alt=""/>,
    gif: <Image className="h-5 w-5 text-green-500" alt=""/>,
    svg: <Image className="h-5 w-5 text-green-500" alt=""/>,
    webp: <Image className="h-5 w-5 text-green-500" alt=""/>,
    bmp: <Image className="h-5 w-5 text-green-500" alt=""/>,
    tiff: <Image className="h-5 w-5 text-green-500" alt=""/>,
    tif: <Image className="h-5 w-5 text-green-500" alt=""/>,
    ico: <Image className="h-5 w-5 text-green-500" alt=""/>,
    heic: <Image className="h-5 w-5 text-green-500" alt=""/>,
    raw: <Image className="h-5 w-5 text-green-500" alt=""/>,
