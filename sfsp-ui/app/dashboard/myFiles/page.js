    ...
    <div className="flex-1 p-6 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="relative flex gap-2">
          ...
          <div className="relative">
            ...
            {showCreateOptions && (
              <div className="absolute right-0 mt-2 w-40 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-md z-10">
                <button className="w-full text-left px-4 py-2 hover:bg-blue-300 dark:hover:bg-gray-700">Create File</button>
                <button className="w-full text-left px-4 py-2 hover:bg-blue-300 dark:hover:bg-gray-700">Create Folder</button>
              </div>
            )}
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {myFiles.map((file, idx) => (
          <div key={idx} className="bg-gray-200 dark:bg-gray-800 rounded-lg p-4 shadow relative group border ">
            ...
            <button
              ...
              className="absolute top-3 right-3 text-gray-500 hover:text-black dark:hover:text-gray-300"
            >
