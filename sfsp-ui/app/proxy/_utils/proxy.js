...
const API_ROUTES = {
  FILES: [
    ...
    "/proxy/files/addAccesslog",
    "/proxy/files/addDescription",
    "/proxy/files/addTags",
    "/proxy/files/changeShareMethod",
    "/proxy/files/deleteFile",
    "/proxy/files/createFolder",
    "/proxy/files/download",
    "/proxy/files/downloadSentFile",
    "/proxy/files/downloadViewFile",
    "/proxy/files/getAccessLog",
    "/proxy/files/getViewAccess",
    "/proxy/files/metadata",
    "/proxy/files/removeTags",
    "/proxy/files/revokeViewAccess",
    "/proxy/files/startUpload",
    "/proxy/files/updateFilePath",
    "/proxy/files/upload",
    "/proxy/files/userWithFileAccess",
  ],
  NOTIFICATIONS: [
    "/proxy/notifications/add",
    "/proxy/notifications/clear",
    "/proxy/notifications/getNotifications",
    "/proxy/notifications/markAsRead",
    "/proxy/notifications/respond",
  ],
  USER: [
    "/proxy/user/addUser",
    "/proxy/user/getUserById",
    "/proxy/user/getUserId",
    "/proxy/user/getUserInfo",
    "/proxy/user/public-keys",
  ],
};
